...
class SchedulerOutputs:
    ...
    num_batched_tokens: int
    # Number of cached tokens included in the batch.
...
class Scheduler:
    ...
    def _schedule_running(
        ...
        while running_queue:
            ...
            while not self._can_append_slots(seq_group, enable_chunking):
                ...
                if enable_chunking:
                    # In chunked-prefill mode, do not let decoding occupy
                    # `max_num_seqs`. Only count prefill sequence groups
                    # towards the `max_num_seqs` concurrency limit so that
                    # chunked prefills can be scheduled aggressively.
    ...
    def _schedule_swapped(
        ...
        while swapped_queue:
            ...
            # Only count the seqs towards max_num_seqs when it's a prefill.
            if is_prefill:
    ...
    def _schedule_chunked_prefill(self) -> SchedulerOutputs:
        ...
        # If the total number of prefill tokens scheduled is less than the
        # configured minimum, try to free token budget by removing scheduled
